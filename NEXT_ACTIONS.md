...
- **Average inline-code cosine:** 0.41 (function body across 48 matched files)
- **Average documentation cosine:** 0.69 (doc text across 48 matched files)
...
- **Target:** `buffer.BufferModule [ZERO] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 12
- **Priority Score:** 12000010.0
- **Functions:** 0/0 matched
...
- **Types:** 0/0 matched
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `ratatui-core/src/buffer.rs` vs expected `buffer.rs`
- **Proposed provenance header:** `// port-lint: source buffer.rs` (current: `// port-lint: source ratatui-core/src/buffer.rs`)
- **Lint issues:** 1
...
- **Similarity:** 0.81
- **Dependents:** 5
- **Priority Score:** 5012002.0
- **Functions:** 16/16 matched (target 25)
- **Missing functions:** _none_
- **Types:** 3/4 matched
- **Missing types:** `Item`
- **Tests:** 12/12 matched
...
- **Target:** `buffer.CellWidth [ZERO] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 2
- **Priority Score:** 2000510.0
- **Functions:** 4/4 matched
- **Missing functions:** _none_
- **Types:** 1/1 matched (target 2)
- **Missing types:** _none_
- **Tests:** 3/3 matched
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `ratatui-core/src/buffer/cell_width.rs` vs expected `buffer/cell_width.rs`
...
- **Proposed provenance header:** `// port-lint: source buffer/cell_width.rs` (current: `// port-lint: source ratatui-core/src/buffer/cell_width.rs`)
...
- **Similarity:** 0.24
- **Dependents:** 0
- **Priority Score:** 61007.6
- **Functions:** 4/9 matched (target 15)
- **Missing functions:** `neg`, `add`, `sub`, `add_assign`, `sub_assign`
- **Types:** 0/1 matched
- **Missing types:** `Output`
- **Tests:** 4/4 matched
...
- **Target:** `buffer.Buffer [STUB] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 0
- **Priority Score:** 46510.0
- **Functions:** 60/63 matched (target 85)
- **Missing functions:** `fmt`, `small_one_line_buffer`, `diff_empty_filled`
...
- **Target:** `tailwind.Tailwind [PROVENANCE-FALLBACK]`
- **Similarity:** 1.00
- **Dependents:** 0
...
- **Target:** `symbols.HalfBlock [PROVENANCE-FALLBACK]`
- **Similarity:** 1.00
- **Dependents:** 0
- **Priority Score:** 0.0
- **Functions:** 0/0 matched
...
- **Target:** `symbols.Braille [PROVENANCE-FALLBACK]`
- **Similarity:** 1.00
- **Dependents:** 0
- **Priority Score:** 0.0
- **Functions:** 0/0 matched
...
- **Target:** `shade.Shade [PROVENANCE-FALLBACK]`
- **Similarity:** 1.00
- **Dependents:** 0
- **Priority Score:** 0.0
- **Functions:** 0/0 matched
...
- **Target:** `symbols.Pixel [PROVENANCE-FALLBACK]`
- **Similarity:** 1.00
- **Dependents:** 0
- **Priority Score:** 0.0
- **Functions:** 0/0 matched
