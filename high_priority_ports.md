...
|------|--------|--------|------------|------|----------|
| 1 | `ratatui-core.buffer` | `buffer.AssertTest` | 0.19 | 88 | 71.0 |
| 2 | `widgets.widget` | `widgets.Widget` | 0.22 | 44 | 34.5 |
| 3 | `ratatui-macros.line` | `ratatui_macros.Line` | 0.52 | 37 | 17.7 |
| 4 | `ratatui-core.text` | `text.TextTest` | 0.26 | 13 | 9.6 |
| 5 | `style.color` | `style.Color` | 0.39 | 15 | 9.2 |
...
| 16 | `buffer.cell` | `buffer.Cell` | 0.68 | 10 | 3.2 |
...
- **ratatui-core.buffer** → `buffer.AssertTest`
  - Similarity: 0.19
  - Dependencies: 88
...
- **ratatui-core.text** → `text.TextTest`
  - Similarity: 0.26
  - Dependencies: 13
