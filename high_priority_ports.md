...
|------|--------|--------|------------|------|----------|
| 1 | `ratatui-core.buffer` | `buffer.BufferModule` | 0.34 | 88 | 58.1 |
...
| 5 | `ratatui-core.text` | `text.TextModule` | 0.33 | 13 | 8.7 |
...
| 12 | `ratatui-core.symbols` | `symbols.SymbolsModule` | 0.33 | 6 | 4.0 |
