# Agent guide - ratatui-kotlin

This file is the quick-reference operating contract for ratatui-kotlin. The longer
...
ratatui-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`ratatui`](./README.md). Upstream Rust is the behavioral oracle while the
