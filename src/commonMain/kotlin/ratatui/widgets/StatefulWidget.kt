 ...
 *
 * For a comprehensive guide to widgets, including interface explanations, implementation
 * patterns, and available widgets, see the [ratatui.widgets] package documentation.
 *
...
interface StatefulWidget<State> {
     ...
     *
     * This is the only method required to implement a custom stateful widget. The state is
     * carried as the [State] type parameter on the interface; pick whatever shape you need
     * (it can be a primitive, a `MutableList`, or a custom class). If you do not need any
     * remembered state between draw calls, implement [Widget] instead.
     */
