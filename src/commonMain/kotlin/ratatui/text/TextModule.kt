 ...
 *
 * Transliteration of `ratatui-core/src/text.rs`.
 *
 ...
 * supported for their properties. Moreover, Ratatui provides convenient conversions so that you
 * can start by using simple `String` and then promote them to the previous primitives when you
 ...
 *
 * In Kotlin, these public types live directly in the [ratatui.text] package.
 */
@Suppress("unused")
internal object TextModule {
    val styledGrapheme = StyledGrapheme::class
    val line = Line::class
