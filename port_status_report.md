...
| Target units (paired) | 161 | - |
| Target files (total) | 161 | - |
...
- Excellent (≥0.85): 3 files (2.1% of matched)
- Good (0.60-0.84): 25 files (17.5% of matched)
- Critical (<0.60): 115 files (80.4% of matched)
...
- `widgets.widget` → `widgets.Widget` (0.33, 44 deps)
- `ratatui-macros.line` → `ratatui_macros.Line` (0.52, 37 deps)
- `style.color` → `style.Color` (0.39, 15 deps)
- `ratatui-core.text` → `text.MaskedTest` (0.31, 13 deps)
...
- `buffer.cell_width` → `buffer.CellWidth` (0.46, 3 deps)
...
- `ratatui-termion.lib` → `ratatui_crossterm.Lib` (0.02)
...
- `examples.sparkline` → `sparkline.SparklineBar` (0.00)
- `tests.state_serde` → `ratatui.StateSerdeTest` (0.51)
- `ratatui-widgets.sparkline` → `sparkline.SparklineTest` (0.00)
- `main.paragraph` → `paragraph.ParagraphTest` (0.00)
- `main.barchart` → `barchart.BarChartTest` (0.00)
- `examples.canvas` → `canvas.CanvasTest` (0.00)
- `main.block` → `block.BlockTest` (0.00)
- `main.gauge` → `gauge.LineGauge` (0.00)
- `main.table` → `table.TableTest` (0.00)
- `examples.gauge` → `gauge.GaugeTest` (0.00)
- `ratatui-widgets.chart` → `chart.ChartTest` (0.00)
- `ratatui-core.widgets` → `widgets.WidgetStylize` (0.06)
- `ratatui-macros.text` → `text.LineTest` (0.14)
- `ratatui-macros.lib` → `ratatui_macros.RowTest` (0.18)
- `main.text` → `text.TextTest` (0.00)
- `ratatui-widgets.lib` → `widgets.HighlightSpacingTest` (0.07)
- `demo2.tabs` → `tabs.TabsTest` (0.07)
- `ratatui-core.layout` → `layout.AlignmentAliasTest` (0.09)
- `main.list` → `list.ListTest` (0.00)
- `text.line` → `text.Line` (0.14)
- `ratatui.widgets` → `widgets.BordersTest` (0.00)
- `text.span` → `text.Span` (0.20)
- `terminal.backend` → `backend.TestBackendTest` (0.00)
- `terminal.render` → `sparkline.RenderDirection` (0.00)
- `main.rect` → `layout.RectOpsTest` (0.00)
- `examples.logo` → `logo.LogoMascotTest` (0.00)
- `examples.calendar` → `calendar.MonthlyTest` (0.00)
- `examples.barchart-grouped` → `chart.LegendPosition` (0.00)
- `examples.barchart` → `chart.GraphType` (0.00)
- `terminal.buffers` → `buffer.CellWidthTest` (0.00)
- `state.lib` → `widgets.StatefulWidgetTest` (0.00)
- `tests.widgets_barchart` → `chart.Axis` (0.26)
- `tests.widgets_block` → `widgets.WidgetTest` (0.00)
...
| `ratatui-widgets.logo` | `logo.RatatuiLogo` | 1/2 | `Size` |
| `ratatui-widgets.barchart` | `barchart.BarChart` | 1/3 | `Item` |
| `buffer.buffer` | `buffer.Buffer` | 1/2 | `Output` |
...
**Documentation coverage:** 7964 / 30100 lines (26%)
...
- `ratatui-widgets.chart` - 100% gap (868 → 0 lines)
- `palette.material` - 94% gap (854 → 49 lines)
- `ratatui.init` - 82% gap (876 → 158 lines)
- `layout.rect` - 80% gap (816 → 167 lines)
- `table.state` - 87% gap (732 → 96 lines)
- `ratatui-core.layout` - 99% gap (620 → 7 lines)
...
... and 71 more files with doc gaps.
