...
| Target units (paired) | 155 | - |
| Target files (total) | 155 | - |
...
- Good (0.60-0.84): 32 files (22.7% of matched)
- Critical (<0.60): 104 files (73.8% of matched)
...
- `ratatui-core.buffer` → `buffer.AssertTest` (0.19, 88 deps)
- `widgets.widget` → `widgets.Widget` (0.22, 44 deps)
- `ratatui-macros.line` → `ratatui_macros.Line` (0.52, 37 deps)
- `ratatui-core.text` → `text.TextTest` (0.26, 13 deps)
...
- `terminal.backend` → `backend.ClearTypeTest` (0.00)
...
- `ratatui-widgets.lib` → `widgets.StatefulWidgetTest` (0.09)
...
- `main.text` → `text.MaskedTest` (0.00)
...
| `ratatui-widgets.table` | `table.Table` | 2/3 | `State`, `Item` |
| `ratatui.init` | `ratatui.Init` | 1/1 | `DefaultTerminal` |
| `text.text` | `text.Text` | 3/5 | `Item`, `IntoIter`, `Output` |
...
**Documentation coverage:** 7906 / 30072 lines (26%)
