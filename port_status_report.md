...
- `ratatui.widgets` → `widgets.WidgetsModule` (0.00)
...
| `ratatui.widgets` | `widgets.WidgetsModule` | 1/1 | `FrameExt` |
...
**Documentation coverage:** 8438 / 28624 lines (29%)
...
- `ratatui.widgets` - 53% gap (1430 → 665 lines)
