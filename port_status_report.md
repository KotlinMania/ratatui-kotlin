...
|--------|-------|------------|
| Function parity | 416/829 matched (target 1352) | 50.2% |
| Class/type parity | 68/95 matched (target 169) | 71.6% |
| Combined symbol parity | 484/924 matched (target 1521) | 52.4% |
| Average function body similarity | 0.41 | inline-code cosine |
| Average documentation similarity | 0.69 | doc text cosine |
...
| Cheat/scoring failures | 13 | forced to 0% |
| Total source files | 61 | 100% |
| Target units (paired) | 132 | - |
| Target files (total) | 132 | - |
...
**Average Function Similarity:** 0.41
...
**Work Distribution:**
- Critical (<0.60): 31 files (63.3% of matched)
...
|------|--------|--------|---------------------|-----------|-------------------|-------|---------------|-------|----------------|----------|
| 1 | `buffer` | `buffer.BufferModule [ZERO] [PROVENANCE-FALLBACK]` | 0.00 | 0/0 matched | _none_ | 0/0 matched | _none_ | - | 0 | 12000010.0 |
...
| 6 | `buffer.cell_width` | `buffer.CellWidth [ZERO] [PROVENANCE-FALLBACK]` | 0.00 | 4/4 matched | _none_ | 1/1 matched (target 2) | _none_ | 3/3 | 0 | 2000510.0 |
| 7 | `text.masked` | `text.Masked [ZERO] [PROVENANCE-FALLBACK]` | 0.00 | 4/9 matched (target 12) | `fmt`, `from`, `debug`, `display`, `into_cow` | 1/1 matched (target 2) | _none_ | 1/4 | 5 | 1051010.0 |
| 8 | `layout.flex` | `layout.Flex [ZERO] [PROVENANCE-FALLBACK]` | 0.00 | 0/0 matched (target 7) | _none_ | 1/1 matched | _none_ | - | 0 | 1000110.0 |
| 9 | `backend.test` | `backend.TestBackend [ZERO] [PROVENANCE-FALLBACK]` | 0.00 | 29/47 matched (target 73) | `fmt`, `buffer_view_with_overwrites`, `assert_buffer_panics`, `assert_scrollback_panics`, `display`, `clear_region_all`, `clear_region_after_cursor`, `clear_region_before_cursor`, `clear_region_current_line`, `clear_region_until_new_line`, `append_lines_not_at_last_line`, `append_lines_at_last_line`, `append_multiple_lines_not_at_last_line`, `append_multiple_lines_past_last_line`, `append_multiple_lines_where_cursor_at_end_appends_height_lines`, `append_multiple_lines_where_cursor_appends_height_lines`, `append_multiple_lines_where_cursor_at_end_appends_more_than_height_lines`, `append_lines_truncates_beyond_u16_max` | 1/3 matched (target 2) | `Result`, `Error` | 1/18 | 20 | 205010.0 |
| 10 | `symbols.merge` | `merge.Merge [ZERO] [PROVENANCE-FALLBACK]` | 0.00 | 6/10 matched (target 11) | `new`, `replace_merge_strategy`, `exact_merge_strategy`, `fuzzy_merge_strategy` | 3/4 matched (target 3) | `BorderSymbolError` | 0/3 | 5 | 51410.0 |
| 11 | `buffer.buffer` | `buffer.Buffer [STUB] [PROVENANCE-FALLBACK]` | 0.00 | 60/63 matched (target 85) | `fmt`, `small_one_line_buffer`, `diff_empty_filled` | 1/2 matched (target 4) | `Output` | 36/38 | 4 | 46510.0 |
| 12 | `buffer.diff` | `buffer.BufferDiff [ZERO] [PROVENANCE-FALLBACK]` | 0.00 | 14/14 matched (target 17) | _none_ | 3/3 matched (target 4) | _none_ | 10/10 | 0 | 1710.0 |
...
| 24 | `layout.size` | `layout.Size [PROVENANCE-FALLBACK]` | 0.24 | 3/8 matched (target 6) | `fmt`, `from_tuple`, `to_tuple`, `from_rect`, `display` | 1/1 matched | _none_ | 0/4 | 5 | 2050907.6 |
| 25 | `rect.ops` | `rect.Ops [PROVENANCE-FALLBACK]` | 0.24 | 4/9 matched (target 15) | `neg`, `add`, `sub`, `add_assign`, `sub_assign` | 0/1 matched | `Output` | 4/4 | 6 | 61007.6 |
...
| 27 | `style.stylize` | `style.Stylize [PROVENANCE-FALLBACK]` | 0.31 | 7/20 matched (target 390) | `fmt`, `str_styled`, `string_styled`, `cow_string_styled`, `temporary_string_styled`, `other_primitives_styled`, `color_modifier`, `fg_bg`, `repeated_attributes`, `all_chained`, `stylize_debug_foreground`, `stylize_debug_background`, `stylize_debug_underline` | 4/5 matched (target 7) | `Item` | 0/12 | 14 | 3142507.0 |
| 28 | `layout.alignment` | `layout.Alignment [PROVENANCE-FALLBACK]` | 0.37 | 2/4 matched (target 7) | `alignment_from_str`, `vertical_alignment_from_str` | 3/3 matched (target 4) | _none_ | 2/4 | 2 | 1020706.2 |
| 29 | `terminal.cursor` | `terminal.CursorTest [PROVENANCE-FALLBACK]` | 0.39 | 5/11 matched (target 5) | `hide_cursor`, `show_cursor`, `get_cursor`, `set_cursor`, `get_cursor_position`, `set_cursor_position` | 0/0 matched (target 1) | _none_ | 5/5 | 6 | 61106.1 |
| 30 | `style.anstyle` | `style.Anstyle [PROVENANCE-FALLBACK]` | 0.43 | 14/16 matched (target 26) | `from`, `try_from` | 1/2 matched (target 3) | `Error` | 14/14 | 3 | 31805.7 |
| 31 | `layout.position` | `layout.Position [PROVENANCE-FALLBACK]` | 0.51 | 10/16 matched (target 21) | `fmt`, `add`, `sub`, `add_assign`, `sub_assign`, `to_string` | 1/2 matched | `Output` | 7/8 | 7 | 4071805.0 |
| 32 | `style` | `style.Style [PROVENANCE-FALLBACK]` | 0.63 | 25/33 matched (target 102) | `fmt`, `deserialize_modifier`, `fmt_stylize`, `combine_individual_modifiers`, `style_can_be_const`, `serialize_then_deserialize`, `deserialize_defaults`, `deserialize_null_modifiers` | 1/1 matched (target 3) | _none_ | 15/20 | 8 | 3083403.8 |
| 33 | `symbols.marker` | `symbols.Marker [PROVENANCE-FALLBACK]` | 0.68 | 2/2 matched (target 6) | _none_ | 1/1 matched (target 11) | _none_ | 2/2 | 0 | 303.2 |
| 34 | `widgets.widget` | `widgets.Widget [PROVENANCE-FALLBACK]` | 0.72 | 7/8 matched (target 11) | `buf` | 2/2 matched (target 3) | _none_ | 6/7 | 1 | 6011003.0 |
| 35 | `layout.offset` | `layout.Offset [PROVENANCE-FALLBACK]` | 0.73 | 5/5 matched | _none_ | 1/1 matched (target 2) | _none_ | 3/3 | 0 | 1000602.8 |
| 36 | `layout.constraint` | `layout.Constraint [PROVENANCE-FALLBACK]` | 0.73 | 10/12 matched (target 32) | `fmt`, `to_string` | 1/1 matched (target 8) | _none_ | 0/1 | 2 | 2021302.8 |
| 37 | `widgets.stateful_widget` | `widgets.StatefulWidget [PROVENANCE-FALLBACK]` | 0.75 | 2/4 matched (target 6) | `buf`, `state` | 3/4 matched | `State` | 2/4 | 3 | 1030802.5 |
| 38 | `buffer.cell` | `buffer.Cell [PROVENANCE-FALLBACK]` | 0.79 | 19/21 matched (target 50) | `eq`, `hash` | 2/2 matched (target 7) | _none_ | 4/4 | 2 | 3022302.2 |
| 39 | `rect.iter` | `rect.Iter` | 0.81 | 16/16 matched (target 25) | _none_ | 3/4 matched | `Item` | 12/12 | 1 | 5012002.0 |
| 40 | `palette.material` | `material.Material [PROVENANCE-FALLBACK]` | 0.91 | 1/1 matched (target 2) | _none_ | 2/2 matched (target 3) | _none_ | - | 0 | 300.9 |
| 41 | `text.grapheme` | `text.Grapheme [PROVENANCE-FALLBACK]` | 0.93 | 5/5 matched (target 8) | _none_ | 1/2 matched | `Item` | 1/1 | 1 | 10700.7 |
| 42 | `terminal.frame` | `terminal.Frame [PROVENANCE-FALLBACK]` | 0.94 | 8/8 matched (target 10) | _none_ | 2/2 matched | _none_ | - | 0 | 1000.6 |
| 43 | `symbols.bar` | `bar.Bar [PROVENANCE-FALLBACK]` | 0.99 | 1/1 matched (target 16) | _none_ | 1/1 matched (target 2) | _none_ | - | 0 | 200.1 |
| 44 | `symbols.block` | `block.Block [PROVENANCE-FALLBACK]` | 0.99 | 1/1 matched (target 43) | _none_ | 1/1 matched (target 4) | _none_ | - | 0 | 200.1 |
| 45 | `palette.tailwind` | `tailwind.Tailwind [PROVENANCE-FALLBACK]` | 1.00 | 0/0 matched | _none_ | 1/1 matched | _none_ | - | 0 | 100.0 |
| 46 | `symbols.braille` | `symbols.Braille [PROVENANCE-FALLBACK]` | 1.00 | 0/0 matched | _none_ | 0/0 matched (target 1) | _none_ | - | 0 | 0.0 |
| 47 | `symbols.half_block` | `symbols.HalfBlock [PROVENANCE-FALLBACK]` | 1.00 | 0/0 matched | _none_ | 0/0 matched (target 1) | _none_ | - | 0 | 0.0 |
| 48 | `symbols.pixel` | `symbols.Pixel [PROVENANCE-FALLBACK]` | 1.00 | 0/0 matched | _none_ | 0/0 matched (target 1) | _none_ | - | 0 | 0.0 |
| 49 | `symbols.shade` | `shade.Shade [PROVENANCE-FALLBACK]` | 1.00 | 0/0 matched | _none_ | 0/0 matched (target 1) | _none_ | - | 0 | 0.0 |

## Cheat Detection / Scoring Failures

- `buffer` -> `buffer.BufferModule [ZERO] [PROVENANCE-FALLBACK]`: function-by-function score forced to 0. BufferModule.kt: score-padding suppression annotation `@Suppress` in Kotlin code
- `layout.rect` -> `layout.Rect [ZERO]`: function-by-function score forced to 0. RectUnitTest.kt: snake_case identifier `inside_top_left` in Kotlin comments
...
- `buffer.cell_width` -> `buffer.CellWidth [ZERO] [PROVENANCE-FALLBACK]`: function-by-function score forced to 0. CellWidth.kt: snake_case identifier `ratatui_core` in Kotlin comments
...
- `layout.flex` -> `layout.Flex [ZERO] [PROVENANCE-FALLBACK]`: function-by-function score forced to 0. no source functions found; target defines functions; report scoring is function-by-function only
- `backend.test` -> `backend.TestBackend [ZERO] [PROVENANCE-FALLBACK]`: function-by-function score forced to 0. TestBackend.kt: snake_case identifier `scroll_region_up` in Kotlin comments; TestBackendTest.kt: snake_case identifier `testScrollRegionUp_0to5_by0` in Kotlin code
...
- `buffer.buffer` -> `buffer.Buffer [STUB] [PROVENANCE-FALLBACK]`: function-by-function score forced to 0. target contains TODO/stub/placeholder markers in function bodies; Buffer.kt: score-padding suppression annotation `@Suppress` in Kotlin code
...
- `symbols.scrollbar` -> `scrollbar.Scrollbar [ZERO] [PROVENANCE-FALLBACK]`: function-by-function score forced to 0. Scrollbar.kt: Rust-only type/unsafe terminology in Kotlin comments; no source functions found; target defines functions; report scoring is function-by-function only

### Critical Ports (Similarity < 0.60, Worst First)

These files need significant work:

- `buffer` -> `buffer.BufferModule [ZERO] [PROVENANCE-FALLBACK]` (0.00, 12 deps)
...
- `buffer.cell_width` -> `buffer.CellWidth [ZERO] [PROVENANCE-FALLBACK]` (0.00, 2 deps)
- `text.masked` -> `text.Masked [ZERO] [PROVENANCE-FALLBACK]` (0.00, 1 deps)
- `layout.flex` -> `layout.Flex [ZERO] [PROVENANCE-FALLBACK]` (0.00, 1 deps)
- `backend.test` -> `backend.TestBackend [ZERO] [PROVENANCE-FALLBACK]` (0.00)
- `symbols.merge` -> `merge.Merge [ZERO] [PROVENANCE-FALLBACK]` (0.00)
- `buffer.buffer` -> `buffer.Buffer [STUB] [PROVENANCE-FALLBACK]` (0.00)
...
- `rect.ops` -> `rect.Ops [PROVENANCE-FALLBACK]` (0.24)
...
| `backend.test` | `backend.TestBackend [ZERO] [PROVENANCE-FALLBACK]` | 2/3 | `Result`, `Error` |
| `rect.ops` | `rect.Ops [PROVENANCE-FALLBACK]` | 1/1 | `Output` |
| `symbols.merge` | `merge.Merge [ZERO] [PROVENANCE-FALLBACK]` | 1/4 | `BorderSymbolError` |
| `buffer.buffer` | `buffer.Buffer [STUB] [PROVENANCE-FALLBACK]` | 1/2 | `Output` |
...
**Documentation coverage:** 3852 / 13422 lines (29%)
...
- `backend.test` - 82% gap (218 → 39 lines)
- `buffer.cell` - 78% gap (212 → 46 lines)
- `widgets.stateful_widget` - 61% gap (256 → 100 lines)
...
- `buffer.cell_width` - 72% gap (40 → 11 lines)
