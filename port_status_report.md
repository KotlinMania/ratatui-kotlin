...
| Target units (paired) | 157 | - |
| Target files (total) | 157 | - |
...
- `main.text` → `text.UnicodeWidth` (0.00)
...
**Documentation coverage:** 7698 / 27104 lines (28%)
...
... and 59 more files with doc gaps.
