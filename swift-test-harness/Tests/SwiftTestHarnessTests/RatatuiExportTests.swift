...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Ratatui.swiftmodule/`
...
//      `import Ratatui` above would fail at compile time.
//
//   2. The static archive `libRatatui.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Ratatui" }` and
//      `flattenPackage = "io.github.kotlinmania.ratatui"` configuration in
...
//      via the `RatatuiLibrary` product.
//
